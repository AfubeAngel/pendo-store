...
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 py-2 px-4 lg:px-[21.5px] product-grid lg:h-auto overflow-auto lg:overflow-visible">
...
const Catalog: React.FC = () => {
  ...
  return (
    <div className="container mt-[28px] mb-[74.5px] lg:mb-[215px] lg:mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 py-2 px-4 lg:px-[21.5px] product-grid">
        {products.map((product: any) => (
          <div key={product.id} onClick={() => openModal(product)}>
            <ProductCard
              imageSrc={product.imageSrc}
