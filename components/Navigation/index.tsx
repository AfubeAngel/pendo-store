...
const Nav: React.FC = () => {
  ...
  return (
    <nav className="bg-[#F5F5F5] border-b-2 border-b-[#F2F4F7] text-black lg:w-full h-20 lg:fixed lg:top-0 lg:z-30 flex items-center justify-between xl:gap-[223px] 2xl:justify-center 2xl:gap-[320px] p-4 lg:px-8 ">
